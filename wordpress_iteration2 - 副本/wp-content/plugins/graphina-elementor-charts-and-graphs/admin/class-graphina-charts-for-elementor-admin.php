...
class Graphina_Charts_For_Elementor_Admin{
    ...
    public function enqueue_scripts(){
        global $pagenow;
        $current_page = ( isset( $_GET['page'] ) ) ? sanitize_text_field( $_GET['page'] ) : 'graphina-chart';
    ...
    public function admin_menu()
    {
        if (current_user_can('manage_options')) {
            ...
            add_submenu_page(
                ...
                __('<span class="dashicons dashicons-star-filled" style="font-size: 17px; color:#0073aa"></span>Go Pro','graphina-charts-for-elementor'),
                'manage_options',
            ...
            <div id="graphina-settings" name="graphina-settings">
                <div class="graphina-main">
                    <div class="graphina-tabs">
                        <ul>
<!--                            <li class="--><?php //echo $activeTab =='general' ? 'active-tab' : '' ?><!--"><a class="tab" href="--><?php //echo admin_url().'admin.php?page=graphina-chart&activetab=general'; ?><!--">--><?php //echo __("General", "graphina-charts-for-elementor"); ?><!--</a></li>-->
<!--                            <li class="--><?php //echo $activeTab =='charts' ? 'active-tab' : '' ?><!--"><a class="tab " href="--><?php //echo admin_url().'admin.php?page=graphina-chart&activetab=charts'; ?><!--">--><?php //esc_html_e("Charts & Tables", "graphina-charts-for-elementor"); ?><!--</a></li> -->
                            <li class="<?php echo $activeTab =='setting' ? 'active-tab' : '' ?>"><a class="tab " href="<?php echo admin_url().'admin.php?page=graphina-chart&activetab=setting'; ?>"><?php  echo __("Settings", "graphina-charts-for-elementor"); ?></a></li>
                            <li class=" <?php echo $activeTab =='database' ? 'active-tab' : '' ?>" style="position: relative ">
                                <span class="graphina-badge" <?php echo $proActive ? 'hidden' : '' ;?> ><?php  echo __("Pro", "graphina-charts-for-elementor"); ?></span>
                                <a class="tab" href="<?php echo admin_url().'admin.php?page=graphina-chart&activetab=database'; ?>">
                                    <?php  echo __("External Database", "graphina-charts-for-elementor"); ?>
                                </a>
                            </li>
<!--                            <li class=" --><?php //echo $activeTab =='addon' ? 'active-tab' : '' ?><!--"><a class="tab" href="--><?php //echo admin_url().'admin.php?page=graphina-chart&activetab=addon'; ?><!--">--><?php // echo __("Addons", "graphina-charts-for-elementor"); ?><!--</a></li>-->
                        </ul>
                                    ...
                                    <div id="setting" class="graphina-tab-detail">
                                        ...
                                        <form id="graphina_settings_tab"><br>
                                            ...
                                            <div class="graphina-admin-charts-setting">
                                                ...
                                                <input type="checkbox" id="graphina_select_chart_js" name="graphina_select_chart_js[]" value='apex_chart_js' <?=  $selected_apex; ?> >
                                                <span class="check-value"><?php echo esc_html__("Apex Chart Js",'graphina-charts-for-elementor');?></span>
                                                <input type="checkbox" id="graphina_select_chart_js" name="graphina_select_chart_js[]" value='google_chart_js' <?= $selected_google; ?> >
                                            ...
                                            <div class="graphina-admin-charts-setting">
                                                ...
                                                <input id="graphina_setting_text" type="text" name="thousand_seperator" value="<?php echo isset($data['thousand_seperator']) && !empty($data['thousand_seperator']) ? $data['thousand_seperator']: 'en-US' ?>">
                                            </div>

                                            <div class="graphina-admin-charts-setting">                                                
                                                <span class="select-chart-title"><?php echo esc_html__("CSV Seperator :",'graphina-charts-for-elementor');?>
                                                    <span <?php echo $proActive ? 'hidden' : '' ;?> class="graphina-badge">Pro</span>
                                                </span>
                                                <select <?php echo $proActive ? '' : 'disabled' ;?> id="graphina_setting_select" name="csv_seperator">
                                                    <option name="comma" value="comma" <?php echo isset($data['csv_seperator']) && !empty($data['csv_seperator']) && $data['csv_seperator']=='comma' ? "selected": '';?> ><?php echo esc_html__("Comma",'graphina-charts-for-elementor');?></option>
                                                    <option name="semicolon" value="semicolon" <?php echo isset($data['csv_seperator']) && !empty($data['csv_seperator']) && $data['csv_seperator']=='semicolon' ? "selected": '';?> ><?php echo esc_html__("Semicolon",'graphina-charts-for-elementor');?></option>
                                                </select>
                                            </div>

                                            <div class="graphina-admin-charts-setting">
                                                <span class="select-chart-title"><?php echo esc_html__("View Port : ",'graphina-charts-for-elementor');?></span>
                                                <input  type="checkbox" id="switch" name="view_port" <?php echo isset($data['view_port']) && !empty($data['view_port']) && $data['view_port']=='on' ? "checked": '';?> >
                                            ...
                                            <div class="graphina-admin-charts-setting">
                                                ...
                                                <input <?php echo $proActive ? '' : 'disabled' ;?> type="checkbox" id="enable_chart_filter" name="enable_chart_filter" <?php echo isset($data['enable_chart_filter']) && !empty($data['enable_chart_filter']) && $data['enable_chart_filter']=='on' ? "checked=checked": '';?> >                                                
                                            ...
                                            <div id="chart_filter_div" class="<?php echo ( !empty($data['enable_chart_filter']) && $data['enable_chart_filter']? '' : 'graphina-d-none') ?>">
                                                <input style="margin-left: unset; background:#2a4cc9;" class="graphina_upload_loader graphina_test_btn" type="button" value="<?php  esc_html_e('Upload Filter Loader', 'graphina-charts-for-elementor'); ?>"/>
                                                <input size="36"
                                                       id="graphina_loader_hidden"
                                                       name="graphina_loader" type="hidden" value="<?php echo !empty($data['graphina_loader']) ?  $data['graphina_loader'] : GRAPHINA_URL . '/admin/assets/images/graphina.gif'; ?>">
                                                <img <?php echo $proActive ? '' : 'hidden' ;?> name="image_src"
                                                     class="graphina_upload_image_preview" id="graphina_upload_image_preview"
                                                     src="<?php echo !empty($data['graphina_loader']) ?  $data['graphina_loader'] : GRAPHINA_URL . '/admin/assets/images/graphina.gif'; ?>"
                                                />
                                                <p style="display: <?php echo $proActive ? 'none' : 'block' ;?>"> <?php echo __('<strong>Chart Filter working only in Graphina pro </strong>','graphina-charts-for-elementor')?></p>
                                            </div>

<!--                                            <div class="graphina-admin-charts-setting" style="margin-top:25px">-->
<!--                                                <span class="select-chart-title">--><?php //echo esc_html__("Chart/Table/Counter Data From add_filter Function: ",'graphina-charts-for-elementor');?>
<!--                                                    <span --><?php //echo $proActive ? 'hidden' : '' ;?><!-- class="graphina-badge">Pro</span>-->
<!--                                                </span>-->
<!--                                                <input --><?php //echo $proActive ? '' : 'disabled' ;?><!-- type="checkbox" id="switch" name="data_from_filter" --><?php //echo isset($data['data_from_filter']) && !empty($data['data_from_filter']) && $data['data_from_filter']=='on' ? "checked": '';?><!-- >-->
<!--                                                <p class="graphina-chart-note"> --><?php //echo __('Note : Get Chart/Table/Counter data from add_filter <strong> example -> add_filter("graphina_extra_data_option",function($data, $type, $settings,$mainId),10,4); <strong> ','graphina-charts-for-elementor')?><!--</p>-->
<!--                                                <p><a href="https://wordpress.iqonic.design/docs/product/graphina-elementor-charts-and-graphs/use-dynamic-data-in-widgets/data-from-wordpress-filter/" style="text-decoration:none" target="_blank">--><?php //echo __('Documentation For add filter','graphina-charts-for-elementor');?><!--</a></p>-->
<!--                                            </div>-->
                                            ...
                                            <div>
                                                ...
                                                <button type="submit" name="save_data" data-url='<?php echo admin_url(); ?>' id="graphina_setting_save_button" class="graphina_test_btn"><?php echo esc_html__("Save Setting",'graphina-charts-for-elementor');?></button>
                                            </div>
                                    ...
                                    <div id="database" class="container">
                                        ...
                                        if(isset($_GET['data']) && $_GET['data']!= ""){
                                            ...
                                            if(gettype($option) != 'boolean' && !empty($option) && is_array($option)){
                                                if(array_key_exists($_GET['data'],$option)){
                                                    $option_value = $option[$_GET['data']];
                                                }
                                            }
                                        }
                                        ?>
                                        <div class="form-header">
                                            <h3 class="head-border"><?php echo esc_html__("Connection Detail",'graphina-charts-for-elementor');?>
                                                <strong style="display: <?php echo !$proActive ? '' : 'none' ?>">
                                                    <!-- <i class="dashicons dashicons-editor-help"></i>
                                                    <a href="https://codecanyon.net/item/graphinapro-elementor-dynamic-charts-datatable/28654061" target="_blank">
                                        ...
                                        <form id="graphina-settings-db-tab">
                                            <div class="row">
                                                <div class="col-25">
                                                    ...
                                                    <input type="text" name="con_name" value="<?php echo isset($option_value['con_name']) &&  !empty($option_value['con_name']) ? $option_value['con_name'] : '' ; ?>" <?php echo (isset($_GET['data']) && $_GET['data']!= "") || (!$proActive) ? 'readonly' : '' ?>>
                                                </div>
                                                <div class="col-75">
                                                    <label class="form-label" for="fname"><?php echo esc_html__("Vendor : ",'graphina-charts-for-elementor');?></label>
                                                    <select id="input1" name="vendor" <?php echo $proActive ? '' :'disabled'?> style="padding: 11px;">
                                            ...
                                            <div class="row">
                                                <div class="col-25">
                                                    ...
                                                    <input type="text" id="lname" name="db_name" value="<?php echo isset($option_value['db_name']) &&  !empty($option_value['db_name']) ? $option_value['db_name'] : '' ; ?>" <?php echo $proActive ? '' :'readonly'?> />
                                                </div>
                                                <div class="col-75">
                                                    <label class="form-label" for="fname"><?php echo esc_html__("Host : ",'graphina-charts-for-elementor');?></label>
                                                    <input type="text" name="host" id="fname" value="<?php echo isset($option_value['host']) &&  !empty($option_value['host']) ? $option_value['host'] : '' ; ?>" <?php echo $proActive ? '' :'readonly'?> />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-25">
                                                    ...
                                                    <input type="text" name="user_name" value="<?php echo isset($option_value['user_name']) &&  !empty($option_value['user_name']) ? $option_value['user_name'] : '' ; ?>" <?php echo $proActive ? '' :'readonly'?>>
                                                </div>
                                                <div class="col-75">
                                                    <label class="form-label" for="fname"><?php echo esc_html__("Password : ",'graphina-charts-for-elementor');?></label>
                                                    <input type="password" id="fname" name="pass" value="<?php echo isset($option_value['pass']) &&  !empty($option_value['pass']) ? $option_value['pass'] : '' ; ?>" <?php echo $proActive ? '' :'readonly'?> />
                                                </div>
                                            </div>

                                            <input type="hidden" name="type" value="<?php echo isset($_GET['data']) && $_GET['data'] != "" ? 'edit' : 'save' ?>" id="graphina_external_database_action_type">
                                            <input type="hidden" name="action" value="graphina_external_database">
                                            <input type="hidden" name="nonce" value="<?php echo  wp_create_nonce('ajax-nonce');?>">
                                            <div class="row" style="padding: 14px 0;">
                                                <button type="submit" name="save" id="graphina_database_save_button" class="graphina_test_btn btn-submit" data-url="<?php echo admin_url()?>" <?php echo $proActive ? '' :'disabled'?>><?php echo esc_html__("Save Setting",'graphina-charts-for-elementor');?></button>
                                                <button type="button" name="graphina_con_test" class="graphina_test_db_btn graphina_test_btn btn-submit" <?php echo $proActive ? '' :'disabled'?>><?php echo esc_html__("Test DB Setting",'graphina-charts-for-elementor');?></button>
                                                <a href="<?php echo admin_url() . 'admin.php?page=graphina-chart&activetab=database'?>">
                                            ...
                                            if(graphina_check_external_database('status')){
                                                ...
                                                <table>
                                                    ...
                                                    foreach (graphina_check_external_database('data') as $key => $value) {
                                                        ?>
                                                        <tr>
                                                            <td ><?php echo esc_html__($value['con_name'], 'graphina-charts-for-elementor'); ?></td>
                                                            <td>
                                                                <a href="<?php echo admin_url() . 'admin.php?page=graphina-chart&activetab=database&data=' . $value['con_name']; ?>">
                                                            ...
                                                            <td>
                                                                <button data-selected="<?php echo $value['con_name']; ?>"
    ...
    public function graphina_save_setting(){
        ...
        if (isset($_POST['action']) && $_POST['action'] == 'graphina_setting_data'){
            unset($_POST['action']);
            unset($_POST['nonce']);
            // if (!empty($_POST['thousand_seperator']) && !empty($_POST['csv_seperator'])) {
            if (!empty($_POST)) {
                update_option('graphina_common_setting', $_POST);
                $status = true;
    ...
    public function graphina_save_external_database_setting(){
        ...
        if(isset($_POST['action']) && $_POST['action'] === 'graphina_external_database'){
            unset($_POST['action']);
            unset($_POST['nonce']);
            $data = get_option('graphina_mysql_database_setting',true);
            $data_exists = gettype($data) != 'boolean' && !empty($data) && is_array($data);
            $actionType = !empty($_POST['type']) ? $_POST['type'] : 'no_action';
            unset($_POST['type']);

            if(in_array($actionType,['save','edit','con_test'])){

                $connectionDetail = $this->graphinaCheckDataBaseConnection($_POST);
            ...
            switch ($actionType){
                case 'delete':
                    ...
                    if($data_exists){
                        if(array_key_exists($_POST['value'],$data)){
                ...
                case 'edit':
                    ...
                    if($data_exists){
                        if(array_key_exists($_POST['con_name'],$data)){
                            $data[$_POST['con_name']] = $_POST;
                            update_option('graphina_mysql_database_setting',$data);
                            $status = true;
                ...
                case 'save':
                    if($data_exists){
                        ...
                        if(!array_key_exists($_POST['con_name'],$data)){
                            ...
                            update_option('graphina_mysql_database_setting',array_merge($data,[$_POST['con_name'] =>$_POST]));
                            $status = true;
                            $message = esc_html__('Connection Details Saved','graphina-charts-for-elementor');
                        }
                    }else{
                        // save database connection detail
                        update_option('graphina_mysql_database_setting',[$_POST['con_name'] =>$_POST]);
                        $status = true;
                        $message = esc_html__('Connection Details Saved','graphina-charts-for-elementor');
                    }
                    break;
