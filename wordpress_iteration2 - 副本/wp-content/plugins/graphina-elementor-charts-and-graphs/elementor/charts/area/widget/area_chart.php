        ...
        if (isRestrictedAccess('area', $this->get_id(), $settings, false) === false) {
            ...
            <script>
                ...
                if ("<?php echo !empty($settings['iq_' . $type . '_chart_tooltip_shared']) ? $settings['iq_' . $type . '_chart_tooltip_shared'] : '';?>" === "yes") {
                    areaOptions.tooltip['enabledOnSeries'] = [<?php echo esc_html($tooltipSeries); ?>];
                }
                ...
                if('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_enable_min_max']) && $settings['iq_' . $type . '_chart_yaxis_enable_min_max'] === 'yes' ?>'){
                    areaOptions.yaxis.tickAmount = parseInt("<?php echo esc_html($settings['iq_' . $type . '_chart_yaxis_datalabel_tick_amount']); ?>") || 6;
                    areaOptions.yaxis.min = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_min_value']) ? $settings['iq_' . $type . '_chart_yaxis_min_value'] : 0  ?>') || 0;
                    areaOptions.yaxis.max = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_max_value']) ? $settings['iq_' . $type . '_chart_yaxis_max_value'] : 0  ?>') || 200;
                }
