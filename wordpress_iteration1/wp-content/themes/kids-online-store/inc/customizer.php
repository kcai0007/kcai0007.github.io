...
function kids_online_store_customize_register($wp_customize){
    ...
    // General Settings
     $wp_customize->add_section('kids_online_store_general_settings',array(
        'title' => esc_html__('General Settings','kids-online-store'),
        'description' => esc_html__('General settings of our theme.','kids-online-store'),
        'priority'   => 30,
    ));

    $wp_customize->add_setting('kids_online_store_preloader_hide', array(
        'default' => '1',
        'sanitize_callback' => 'kids_online_store_sanitize_checkbox'
    ));
    $wp_customize->add_control( new WP_Customize_Control($wp_customize,'kids_online_store_preloader_hide',array(
        'label'          => __( 'Show Theme Preloader', 'kids-online-store' ),
        'section'        => 'kids_online_store_general_settings',
        'settings'       => 'kids_online_store_preloader_hide',
        'type'           => 'checkbox',
    )));

    $wp_customize->add_setting( 'kids_online_store_preloader_bg_color', array(
        'default' => '#000',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'kids_online_store_preloader_bg_color', array(
        'label' => esc_html__('Preloader Background Color','kids-online-store'),
        'section' => 'kids_online_store_general_settings',
        'settings' => 'kids_online_store_preloader_bg_color' 
    )));
    
    $wp_customize->add_setting( 'kids_online_store_preloader_dot_1_color', array(
        'default' => '#fff',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'kids_online_store_preloader_dot_1_color', array(
        'label' => esc_html__('Preloader First Dot Color','kids-online-store'),
        'section' => 'kids_online_store_general_settings',
        'settings' => 'kids_online_store_preloader_dot_1_color' 
    )));

    $wp_customize->add_setting( 'kids_online_store_preloader_dot_2_color', array(
        'default' => '#7fd3eb',
        'sanitize_callback' => 'sanitize_hex_color'
    ));
    $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'kids_online_store_preloader_dot_2_color', array(
        'label' => esc_html__('Preloader Second Dot Color','kids-online-store'),
        'section' => 'kids_online_store_general_settings',
        'settings' => 'kids_online_store_preloader_dot_2_color' 
    )));
