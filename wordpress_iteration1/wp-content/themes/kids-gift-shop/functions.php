...
function kids_gift_shop_remove_customize_register() {
    global $wp_customize;
    $wp_customize->remove_section( 'kids_online_store_color_option' );
...
function kids_gift_shop_remove_my_action() {
    remove_action( 'admin_menu','kids_online_store_themepage' );
    remove_action( 'after_switch_theme','kids_online_store_setup_options' );
}
add_action( 'init', 'kids_gift_shop_remove_my_action');
