...
class Babysitting_Day_Care_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'babysitting-day-care'); ?>">
                      </div>
                    <?php
                    $babysitting_day_care_font_awesome_icon_array = babysitting_day_care_font_awesome_icon_array();
                    foreach ($babysitting_day_care_font_awesome_icon_array as $babysitting_day_care_font_awesome_icon) {
                            $icon_class = $this->value() == $babysitting_day_care_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($babysitting_day_care_font_awesome_icon).'"></i>
                            <span class="babysitting-day-care-social-class">'.esc_attr($babysitting_day_care_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function babysitting_day_care_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'babysitting_day_care_customizer_script' );

if(!function_exists('babysitting_day_care_font_awesome_icon_array')){
    function babysitting_day_care_font_awesome_icon_array(){
