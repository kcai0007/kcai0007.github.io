 ...
 */
define('GRAPHINA_CHARTS_FOR_ELEMENTOR_VERSION', '1.5.8');
...
//if(empty(get_option('test_option_for_google_chart'))) {
//    array_push($data,['graphina_select_chart_js' => ['apex_chart_js', 'google_chart_js'] ]);
//    update_option('test_option_for_google_chart', true);
//}
//
//update_option('graphina_common_setting', $data);
