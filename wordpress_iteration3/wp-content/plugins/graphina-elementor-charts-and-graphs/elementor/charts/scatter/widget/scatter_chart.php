        ...
        if (isRestrictedAccess('area', $this->get_id(), $settings, false) === false) {
            ...
            <script>
                ...
                var scatterOptions = {
                    ...
                    dataLabels: {
                        ...
                        style: {
                            ...
                            colors: ['<?php echo !empty($settings['iq_' . $type . '_chart_datalabel_font_color'] ) && $settings['iq_' . $type . '_chart_datalabel_font_color'] === "yes" ? strval($settings['iq_' . $type . '_chart_datalabel_font_color']) : '#000000'; ?>']
                        },
                        background: {
                            enabled: false,
                        },
                ...
                if('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_enable_min_max']) && $settings['iq_' . $type . '_chart_yaxis_enable_min_max'] === 'yes' ?>'){
                    ...
                    scatterOptions.yaxis.min = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_min_value']) ? $settings['iq_' . $type . '_chart_yaxis_min_value'] : 0  ?>') || 0;
                    scatterOptions.yaxis.max = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_max_value']) ? $settings['iq_' . $type . '_chart_yaxis_max_value'] : 0  ?>') || 200;
                }
                ...
                if("<?php echo !empty($settings['iq_' . $type . '_chart_opposite_yaxis_title_enable']) && $settings['iq_' . $type . '_chart_opposite_yaxis_title_enable'] == 'yes' ;  ?>"){
                    ...
                    if('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_enable_min_max']) && $settings['iq_' . $type . '_chart_yaxis_enable_min_max'] === 'yes' ?>'){
                        ...
                        areaYaxisTemp.min = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_min_value']) ? $settings['iq_' . $type . '_chart_yaxis_min_value'] : 0  ?>') || 0;
                        areaYaxisTemp.max = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_max_value']) ? $settings['iq_' . $type . '_chart_yaxis_max_value'] : 0  ?>') || 200;
                    }
