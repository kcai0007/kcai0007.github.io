...
//         require GRAPHINA_ROOT . '/elementor/google_charts/donut/render/donut_google_chart.php';
        ...
        if(!empty($settings['iq_' . $type . '_chart_label_prefix_postfix'])){
            ...
            $donutDataLength = count($donutData);
            for ($x = 0; $x < $donutDataLength; $x++) {
                $donutData[$x][0] = $labelPrefix.$donutData[$x][0].$labelPostfix;
            }
        }
        ...
        <script type="text/javascript">
            ...
            function drawChart() {
                ...
                var chart = new google.visualization.PieChart(document.getElementById('donut_google_chart<?php esc_attr_e($this->get_id()); ?>'));
