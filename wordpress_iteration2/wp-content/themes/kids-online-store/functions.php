...
function kids_online_store_theme_color() {
    ...
    $kids_online_store_preloader_bg_color = get_theme_mod('kids_online_store_preloader_bg_color');
    $kids_online_store_preloader_dot_1_color = get_theme_mod('kids_online_store_preloader_dot_1_color');
    $kids_online_store_preloader_dot_2_color = get_theme_mod('kids_online_store_preloader_dot_2_color');

    	if(get_theme_mod('kids_online_store_preloader_bg_color') == '') {
			$kids_online_store_preloader_bg_color = '#000';
		}
		if(get_theme_mod('kids_online_store_preloader_dot_1_color') == '') {
			$kids_online_store_preloader_dot_1_color = '#fff';
		}
		if(get_theme_mod('kids_online_store_preloader_dot_2_color') == '') {
			$kids_online_store_preloader_dot_2_color = '#7fd3eb';
		}
	...
	$theme_color_css = '
		...
		.loading{
			background-color: '.esc_attr($kids_online_store_preloader_bg_color).';
		 }
		 @keyframes loading {
		  0%,
		  100% {
		  	transform: translatey(-2.5rem);
		    background-color: '.esc_attr($kids_online_store_preloader_dot_1_color).';
		  }
		  50% {
		  	transform: translatey(2.5rem);
		    background-color: '.esc_attr($kids_online_store_preloader_dot_2_color).';
		  }
		}
	';
