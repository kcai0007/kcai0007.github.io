...
<footer id="colophon" class="site-footer border-top">
    <div class="container">
	        ...
	        <div class="site-info col-lg-7 col-md-7 col-12">
	            <div class="footer-menu-left">
	            	<?php if(! get_theme_mod('kids_online_store_footer_text_setting') != ''){ ?>
					    <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'kids-gift-shop' ) ); ?>">
							<?php
							/* translators: %s: CMS name, i.e. WordPress. */
							printf( esc_html__( 'Proudly powered by %s', 'kids-gift-shop' ), 'WordPress' );
							?>
					    </a>
					    <span class="sep mr-1"> | </span>
					    <span>
					    	<?php
				            	/* translators: 1: Kids Gift Shop WordPress Theme,  */
				            	printf( esc_html__( ' %1$s ', 'kids-gift-shop' ),'Kids Gift Shop WordPress Theme' );
				            ?>
					        <?php
					        	/* translators: 1: TheMagnifico. */
					        	printf( esc_html__( 'by %1$s.', 'kids-gift-shop' ),'TheMagnifico'  );
					        ?>
					    </span>
					<?php }?>
	    ...
	    <a id="button"><?php esc_html_e('TOP','kids-gift-shop'); ?></a>
    </div>
</footer>
</div>
