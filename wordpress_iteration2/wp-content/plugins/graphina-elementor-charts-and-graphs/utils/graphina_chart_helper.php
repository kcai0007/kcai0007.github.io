...
function graphina_chart_data_enter_options($type = '', $chartType = '', $first = false)
{
    ...
    switch ($type) {
        ...
        case 'dynamic':
            ...
            $sql_builder_for = ['line', 'column', 'area', 'pie', 'donut', 'radial', 'radar', 'polar','data_table_lite','distributed_column','scatter','mixed','brush', 'pie_google','donut_google','line_google','area_google','column_google','bar_google','gauge_google','geo_google'];
...
if(!in_array($type, ['geo_google'])){
    $this_ele->add_control(
        ...
        [
            ...
            'default' => $defaultCount !== 0 ? $defaultCount : (in_array($type, ['pie', 'polar', 'donut', 'radial', 'bubble','pie_google','donut_google']) ? 5 : 1),
            'min' => 1,
...
//                            ]
    ...
    if ($showNegative && (!in_array($type, ['pie_google','donut_google','gauge_google','geo_google']))) {
        $this_ele->add_control(
    ...
    if (!in_array($type, ['nested_column','brush','area_google', 'pie_google','line_google', 'bar_google','column_google','donut_google','gauge_google','geo_google'])) {
        $this_ele->add_control(
    ...
    if(!in_array($type,['mixed','brush','nested_column','area_google', 'pie_google','line_google', 'bar_google','column_google','donut_google','gauge_google','geo_google'])){
...
function graphina_common_chart_setting($this_ele, $type = 'chart_id', $showDataLabel = false, $labelAddFixed = true, $labelPosition = false, $showLabelBackground = true, $showLabelColor = true)
{
    ...
    if(in_array($type,['line','area','column','pie','polar','donut','scatter'])){
        $this_ele->add_control(
    ...
    if($type != 'brush'){
        ...
        if(!in_array($type,['line_google','area_google','bar_google','column_google','pie_google','donut_google','geo_google','gauge_google'])){
            $this_ele->add_control(
    ...
    if(!in_array($type,['line_google','area_google','bar_google','column_google','pie_google','donut_google','gauge_google'])){
        $this_ele->add_control(
    ...
    if(!in_array($type,['line_google','area_google','column_google','bar_google','pie_google','donut_google'])){
...
function graphina_common($this_ele, $type = 'chart_id', $showTheme = true, $shared = true)
{
    $this_ele->add_control(
             ...
             'conditions'=>[
                 ...
                 'terms' => [
                     [
                         ...
                         'terms' => [
                             [
                                 'name' => 'iq_' . $type1 . '_chart_is_pro',
                                 'operator' => '==',
                                 'value' => 'false'
                             ],
                             [
                                 'name' => 'iq_' . $type1 . '_chart_data_option',
                                 'operator' => '==',
                                 'value' => 'manual'
                             ]
                         ]
