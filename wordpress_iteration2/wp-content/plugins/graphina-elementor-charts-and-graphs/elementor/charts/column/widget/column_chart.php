...
class Column_chart extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Starting Shape', 'graphina-charts-for-elementor'),
                'type' => Controls_Manager::SELECT,
                'default' => 'flat',
                'options' => [
            ...
            <script>
                ...
                if ("<?php echo esc_html($settings['iq_' . $type . '_chart_yaxis_label_show']); ?>" === "yes") {
                    columnOptions.yaxis.labels.formatter = function (val) {
                        if('<?php echo $settings['iq_' . $type . '_chart_stacked'] != 'yes'?>'){
                            ...
                            if("<?php echo esc_html($settings['iq_' . $type . '_chart_yaxis_format_number']); ?>" === "yes"){
                                val = val.toLocaleString('<?php echo $localStringType ?>',{maximumFractionDigits: decimal})
                            }
                ...
                if("<?php echo esc_html($settings['iq_' . $type . '_chart_stack_type']); ?>" !== '100%'){
                    ...
                    columnOptions.dataLabels.formatter = function (val) {
                        ...
                        if("<?php echo !empty($settings['iq_' . $type . '_chart_number_format_commas']) &&  esc_html($settings['iq_' . $type . '_chart_number_format_commas']); ?>" === "yes"){
                            val = val.toLocaleString('<?php echo $localStringType ?>')
                        }
                        else if("<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_label_pointer']) && esc_html($settings['iq_' . $type . '_chart_yaxis_label_pointer']); ?>" === 'yes'
                            &&  typeof graphinaAbbrNum  !== "undefined"){      
                                val = graphinaAbbrNum(val ,  parseInt("<?php echo esc_html($settings['iq_' . $type . '_chart_yaxis_label_pointer_number']); ?>") || 0 );
                    ...
                    columnOptions.dataLabels.formatter = function (val) {
                        ...
                        val =  parseFloat(val).toFixed(parseInt("<?php echo !empty($settings['iq_' . $type . '_chart_stack_type_decimal']) ?$settings['iq_' . $type . '_chart_stack_type_decimal'] : 0 ?>") || 0 ) ;
                        if("<?php echo !empty($settings['iq_' . $type . '_chart_number_format_commas']) &&  esc_html($settings['iq_' . $type . '_chart_number_format_commas']); ?>" === "yes"){
                           val = parseFloat(val).toLocaleString('<?php echo $localStringType ?>')
                        }
                        val = '<?php echo esc_html($dataLabelPrefix) ?>' + val + '<?php echo esc_html($dataLabelPostfix) ?>';
                        return val;
                    };
                }
                ...
                if('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_enable_min_max']) && $settings['iq_' . $type . '_chart_yaxis_enable_min_max'] === 'yes' ?>'){
                    ...
                    columnOptions.yaxis.min = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_min_value']) ? $settings['iq_' . $type . '_chart_yaxis_min_value'] : 0  ?>') || 0;
                    columnOptions.yaxis.max = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_max_value']) ? $settings['iq_' . $type . '_chart_yaxis_max_value'] : 0  ?>') || 200;
                }
                ...
                if("<?php echo !empty($settings['iq_' . $type . '_chart_opposite_yaxis_title_enable']) && $settings['iq_' . $type . '_chart_opposite_yaxis_title_enable'] == 'yes' ;  ?>"){
                    ...
                    if('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_enable_min_max']) && $settings['iq_' . $type . '_chart_yaxis_enable_min_max'] === 'yes' ?>'){
                        columnYaxisTemp.tickAmount = parseInt('<?php echo $settings['iq_' . $type . '_chart_opposite_yaxis_tick_amount']; ?>') || 6;
                        columnYaxisTemp.min = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_min_value']) ? $settings['iq_' . $type . '_chart_yaxis_min_value'] : 0  ?>') || 0;
                        columnYaxisTemp.max = parseInt('<?php echo !empty($settings['iq_' . $type . '_chart_yaxis_max_value']) ? $settings['iq_' . $type . '_chart_yaxis_max_value'] : 0  ?>') || 200;
                    }
