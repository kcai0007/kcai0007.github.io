...
class QiAddonsForElementor_Framework_Elementor_Translator {
	...
	function create_controls( $elementor_object, $shortcode_object ) {
		...
		$elementor_object->start_controls_section(
			...
			array(
				'label' => esc_html__( 'Want more features?', 'qi-addons-for-elementor' ),
				'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
			)
		);
		...
		$elementor_object->add_control(
			...
			array(
				'type'            => \Elementor\Controls_Manager::RAW_HTML,
				/* translators: %s admin link */
				'raw'             => sprintf( esc_html__( 'The %1$s Premium version %2$s of our Qi Addons for Elementor plugin is ready for you to try it out!', 'qi-addons-for-elementor' ), '<a href="https://qodeinteractive.com/qi-addons-for-elementor/pricing/" target="_blank" rel="noopener">', '</a>' ),
